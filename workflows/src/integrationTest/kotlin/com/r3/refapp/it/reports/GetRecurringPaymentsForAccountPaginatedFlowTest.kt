...
class GetRecurringPaymentsForAccountPaginatedFlowTest : AbstractITHelper() {

    @Test
    fun `test GetRecurringPaymentsForAccountPaginatedFlow happy path`() {
        ...
        Thread.sleep(3 * 1000)
        network.runNetwork()
        val response = executeFlowWithRunNetwork(GetRecurringPaymentsForAccountPaginatedFlow(repositoryQueryParams, account1.accountData.accountId,
    ...
    @Test
    fun `test GetRecurringPaymentsForAccountPaginatedFlow fails with unexistent sort column`() {
