 ...
 * [repositoryQueryParams], [accountId], [dateFrom] and [dateTo]. [RepositoryQueryParams.searchTerm] can be matched in
...
@StartableByRPC
@InitiatingFlow
class GetRecurringPaymentsForAccountPaginatedFlow(val repositoryQueryParams: RepositoryQueryParams, val accountId: UUID,
    ...
    override fun call(): PaginatedResponse<RecurringPaymentLogSchemaV1.RecurringPaymentLog> {
        ...
        return recurringPaymentLogRepository.getRecurringPaymentsForAccountPaginated(repositoryQueryParams, accountId,
                dateFrom, dateTo)
    }
}