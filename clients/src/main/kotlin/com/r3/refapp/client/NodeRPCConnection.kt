...
open class NodeRPCConnection(
    ...
    /**
     * Initializes an rpc connection with the corda node
     */
    @PostConstruct
    ...
    /**
     * Function that runs before the connection is closed
     * It is used to notify the corda node about the connection's termination
     */
    @PreDestroy
    fun close() {
